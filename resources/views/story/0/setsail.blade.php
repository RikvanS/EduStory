...
@section('content')
    ...
    <p class="sailtext">"Wat een wind hè?" roept Jan, terwijl hij je het schip rondleidt. Je ziet Groningen steeds kleiner worden terwijl jullie wegvaren. Jan laat je zien waar je kunt slapen en legt je uit wat jouw werk wordt tijdens de reis. "Nou {{ Auth::user()->name }}, je bent eigenlijk ons manusje-van-alles. Je meeste werk bestaat uit goederen verplaatsen en afleveren. Hebben ze je al wat over de reis verteld eigenlijk?" vraagt Jan. "Nee," zeg je, "ik heb alleen gehoord dat we naar Lubeck gaan." "Dat klopt," zegt Jan, "en daarna via Visby naar Riga. Dat zijn allemaal Hanzesteden dus daar kunnen we veilig handel drijven." Je hebt geen idee wat Hanzesteden zijn, maar Jan legt het je maar al te graag uit. Blijkbaar is het een handelssamenwerking tussen tientallen Europese steden.</p>
            
        <p class="sailtext">"Ben je al eens eerder in Lubeck geweest?"
