...
{{-- Gearriveerd in Lubeck --}}
            ...
            <a href="/chapters/1" class="log-redirect"><h2 class="log-title space-top">--Lubeck--</h2></a>
...
{{-- Visby gearriveerd --}}
            ...
            <a href="/chapters/2a" class="log-redirect"><h2 class="log-title space-top">--Visby--</h2></a>
...
{{-- Gearriveerd in gdansk --}}
            ...
            <a href="/chapters/2b" class="log-redirect"><h2 class="log-title space-top">--Gdansk--</h2></a>
...
{{-- Riga gearriveerd --}}
           ...
           <a href="/chapters/3" class="log-redirect"><h2 class="space-top" class="log-title">--Riga--</h2></a>
